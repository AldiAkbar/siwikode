...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="flash-data" data-flashdata="<?= $this->session->flashdata('message'); ?>" data-title="Role"></div>
                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/role/deleteRole/' . $r['id']); ?>" class="badge badge-danger tombol-hapus">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
