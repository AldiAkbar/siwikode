    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header bg-primary" style="color: white;">Data Kuliner</div>
                    <div class="card-body">
                        <div class="form-group">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                        </div>
                        <div class="form-group">
                        <label for="m">Nama Restoran</label>
                        <input id="m" name="nama_restoran" class="form-control"></input>
                        <?= form_error('nama_restoran','<small class="text-danger">','</small>') ?>
                        </div>
                        <div class="form-group">
                        <label for="s">Jenis Restoran</label>
                ...
                <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary" style="color: white;">Deskripsi Kuliner</div>
                    <div class="card-body">
                        <div class="form-group">
