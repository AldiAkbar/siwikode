...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="flash-data" data-flashdata="<?= $this->session->flashdata('message'); ?>" data-title="Submenu"></div>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/subMenu/deleteSubMenu/' . $sm['id']); ?>" class="badge badge-danger tombol-hapus">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
